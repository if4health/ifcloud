...
const schema = Joi.object({
  ...
  onlyComponent: Joi.string().valid("true", "false").required().messages({
    "any.required": "returnOnlyFieldsComponents is required!",
    "any.only": "returnOnlyFieldsComponents must be 'true' or 'false'!",
    "string.base": "returnOnlyFieldsComponents must be a string!",
  }),
  componentIndex: Joi.array()
    .items(
 ...
 * @deprecated
 */
module.exports.operationStarterValidationForm = (data) => {
